...
- don't run automated github actions on forks ([#4557](https://github.com/Azure/aks-engine/issues/4557))
- deprecate prow configurations ([#4547](https://github.com/Azure/aks-engine/issues/4547))
- use make build in Windows VHD build CI ([#4558](https://github.com/Azure/aks-engine/issues/4558))
- add CODEOWNERS file ([#4545](https://github.com/Azure/aks-engine/issues/4545))
...
- undo test/e2e vendor ([#4543](https://github.com/Azure/aks-engine/issues/4543))
- go mod vendor action tweaks ([#4541](https://github.com/Azure/aks-engine/issues/4541))
- standardize go mod vendor ([#4539](https://github.com/Azure/aks-engine/issues/4539))
- use single quotes for equality comparison ([#4538](https://github.com/Azure/aks-engine/issues/4538))
- simplify generated consts flows ([#4536](https://github.com/Azure/aks-engine/issues/4536))
- use go 1.16 everywhere ([#4528](https://github.com/Azure/aks-engine/issues/4528))
- remove unused jenkins/ directory ([#4529](https://github.com/Azure/aks-engine/issues/4529))
...
### Features 🌈
- add support for Kubernetes 1.22.0-beta.1 ([#4570](https://github.com/Azure/aks-engine/issues/4570))
- enable new clusters w/ 1000 count node pools ([#4569](https://github.com/Azure/aks-engine/issues/4569))
- add support for Kubernetes v1.22.0-beta.0 ([#4478](https://github.com/Azure/aks-engine/issues/4478))
...
- update moby/docker, and runc for linux only ([#4562](https://github.com/Azure/aks-engine/issues/4562))
...
- Update hack/tools dependencies ([#4533](https://github.com/Azure/aks-engine/issues/4533))
