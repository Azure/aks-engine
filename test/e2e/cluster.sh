...
-e GUARD_CA_CERTIFICATE=${GUARD_CA_CERTIFICATE:-$DEFAULT_CA} \
-e GUARD_CA_CERTIFICATE_KEY=${GUARD_CA_CERTIFICATE_KEY:-$DEFAULT_CA_KEY} \
-e GUARD_CLIENT_CERTIFICATE=${GUARD_CLIENT_CERTIFICATE:-$DEFAULT_CERT} \
-e GUARD_CLIENT_CERTIFICATE_KEY=${GUARD_CLIENT_CERTIFICATE_KEY:-$DEFAULT_CERT_KEY} \
-e GUARD_SERVER_CERTIFICATE=${GUARD_SERVER_CERTIFICATE:-$DEFAULT_CERT} \
-e GUARD_SERVER_CERTIFICATE_KEY=${GUARD_SERVER_CERTIFICATE_KEY:-$DEFAULT_CERT_KEY} \
