...
```bash
aks-engine custom-vnet.json
```

This command will output three files:

```console
wrote _output/dns_prefix/apimodel.json
wrote _output/dns_prefix/azuredeploy.json
wrote _output/dns_prefix/azuredeploy.parameters.json
