...
If you created a Kubernetes cluster with one or multiple Ubuntu 16.04-LTS node pools whose VM size is `Standard_NC*` or `Standard_NV*` you can schedule GPU workloads on your cluster.
...
Note: The 418.40.04 drivers do not support Ubuntu 18.04-LTS node pool configurations.
