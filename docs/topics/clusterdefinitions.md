...
| azure-cloud-provider                            | true                                                                                | 0    | Delivers required ClusterRole and ClusterRoleBinding resources required for running the Azure cloudprovider runtime. May not be disabled.                                                                                                                                                                         |
