...
| etcdStorageLimitGB                   | no                        | Size in GB to limit etcd data storage to. Defaults to 2, maximum is 8. See [here](https://etcd.io/docs/v3.3.13/dev-guide/limit/#storage-size-limit) for more information. |
...
| windowsPauseImageURL          | no       | Path to a Windows pause image. Default values will be maintained by aks-engine team.                                 |
| alwaysPullWindowsPauseImage   | no       | If set to `true`, it will always pull the Windows pause image from MCR repo. Default: `false`                                   |
...
| enableAHUB                    | no       | If set to `true`, Windows nodepools was licensed as Windows Server on-premises. For more information, see [Azure Hybrid Use Benefit for Windows Server](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-hybrid-use-benefit-licensing?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) |
