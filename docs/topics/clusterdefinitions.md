...
| kubeReservedCgroup               | no                        | The name of a systemd slice to create for containtment of both kubelet and the container runtime. This should not point to an existing systemd slice. Defaults to the empty string, which results in kubelet and docker being place in the system slice.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
