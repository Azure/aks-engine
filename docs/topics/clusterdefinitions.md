...
| enableEncryptionWithExternalKms   | no                        | Enable [kubernetes data encryption at rest with external KMS](https://kubernetes.io/docs/tasks/administer-cluster/encrypt-data/).This is currently a beta feature. (boolean - default == false)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
