...
| [pod-security-policy](https://kubernetes.io/docs/concepts/policy/pod-security-policy/)                            | required for Kubernetes v1.15+; defaults to false for Kubernetes 1.14 and earlier                                                                                | 1    | a cluster-level resource that controls security sensitive aspects of the pod specification                                                                                                                                                                         |
