...
| [keyvault-flexvolume](../../examples/addons/keyvault-flexvolume/README.md)                                | true (for <=1.15 clusters)                                                                                 | as many as linux agent nodes    | Access secrets, keys, and certs in Azure Key Vault from pods. This solution will be **DEPRECATED** in favor of csi-secrets-store addon                                                                                                                                                                  |
