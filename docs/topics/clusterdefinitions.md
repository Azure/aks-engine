...
| enableRbac                      | no       | Enable [Kubernetes RBAC](https://kubernetes.io/docs/admin/authorization/rbac/) (boolean - default == true) RBAC support is required for Kubernetes 1.15.0 and greater, so enableRbac=false is not an allowed configuration for clusters >= 1.15.0. If you have upgrade a < 1.15 cluster to 1.15.0 or greater and RBAC is disabled, it will be statically enabled during the upgrade operation.                                                                                                                                                                                                                                                                                                 |
