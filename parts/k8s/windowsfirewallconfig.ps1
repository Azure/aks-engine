...
winrm quickconfig -q 2> out-null
winrm set winrm/config/service/Auth '@{Basic="true"}' 2> out-null
winrm set winrm/config/service '@{AllowUnencrypted="true"}' 2> out-null
winrm set winrm/config/winrs '@{MaxMemoryPerShellMB="1024"}' 2> out-null
...
#download pscp here
Write-Host "Download pscp on windows node."
Invoke-webrequest -Uri https://the.earth.li/~sgtatham/putty/latest/w64/pscp.exe -o c:\k\pscp.exe
