...
installMoby() {
    ...
    retrycmd_if_failure_no_stats 120 5 25 curl "https://moby.blob.core.windows.net/moby-test/3.0.6/amd64/artifacts.tgz" > /tmp/moby/artifacts.tgz || exit $ERR_MOBY_APT_LIST_TIMEOUT
