...
installDeps() {
    ...
    apt_get_install 30 1 600 apt-transport-https blobfuse ca-certificates ceph-common cgroup-lite chrony cifs-utils conntrack ebtables ethtool fuse git glusterfs-client htop iftop init-system-helpers iotop iproute2 ipset iptables jq mount nfs-common pigz socat sysstat util-linux xz-utils zip || exit $ERR_APT_INSTALL_TIMEOUT
}
