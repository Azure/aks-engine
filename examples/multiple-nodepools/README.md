...
A complete example is contained in the `multipool.json` apimodel in this directory. To add a node pool to an existing apimodel, just add another `agentPoolProfile` section:
