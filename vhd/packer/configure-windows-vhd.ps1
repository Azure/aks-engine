...
function Get-FilesToCacheOnVHD
{
    ...
    $map = @{
        ...
        "c:\akse-cache\win-vnet-cni\" = @(
            "https://kubernetesartifacts.azureedge.net/azure-cni/2020.2.21.1/binaries/azure-vnet-cni-windows-amd64-2020.2.21.1-signed.zip"
        )
    }
...
function Install-WindowsPatches
{
    ...
    $patchUrls = @("http://download.windowsupdate.com/c/msdownload/update/software/secu/2020/03/windows10.0-kb4538461-x64_42e8cfbe70644506b357941eafe667e967d4bbf2.msu")
