...
function Get-FilesToCacheOnVHD {
    ...
    $map = @{
        "c:\akse-cache\"              = @(
            ...
            "https://kubernetesartifacts.azureedge.net/aks-engine/windows/provisioning/signedscripts-v0.0.6.zip",
            "https://kubernetesartifacts.azureedge.net/aks-engine/windows/provisioning/signedscripts-v0.0.7.zip"
        );
