...
function Get-FilesToCacheOnVHD
{
    ...
    $map = @{
        ...
        "c:\akse-cache\win-k8s\" = @(
            ...
            "https://kubernetesartifacts.azureedge.net/kubernetes/v1.17.1/windowszip/v1.17.2-1int.zip",
            "https://kubernetesartifacts.azureedge.net/kubernetes/v1.17.2/windowszip/v1.17.3-1int.zip"
        );
