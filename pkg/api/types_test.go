...
func TestAgentPoolProfileGetKubernetesLabels(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			rg:       "my-resource-group",
			expected: "kubernetes.azure.com/role=agent,agentpool=,storageprofile=managed,storagetier=,kubernetes.azure.com/cluster=my-resource-group",
		},
		{
			name: "N series",
			ap: AgentPoolProfile{
			...
			rg:       "my-resource-group",
			expected: "kubernetes.azure.com/role=agent,agentpool=,accelerator=nvidia,kubernetes.azure.com/cluster=my-resource-group",
		},
		{
		...
		},
		{
			...
			rg:       "my-resource-group",
			expected: "kubernetes.azure.com/role=agent,agentpool=,storageprofile=managed,storagetier=Standard_LRS,accelerator=nvidia,kubernetes.azure.com/cluster=my-resource-group,mycustomlabel1=foo,mycustomlabel2=bar",
		},
	}
