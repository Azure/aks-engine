...
func TestSetAllPlatformFaultDomainCount(t *testing.T) {
	...
	for i := 1; i <= 3; i++ {
		cs.SetAllPlatformFaultDomainCount(i)
...
func TestSetAllPlatformFaultDomainCountMixedAvailabilityProfiles(t *testing.T) {
	// check that the default value is nil
	cs := CreateMockContainerService("testcluster", defaultTestClusterVer, 1, 3, false)
	...
	for _, pool := range cs.Properties.AgentPoolProfiles {
		...
		pool.AvailabilityProfile = VirtualMachineScaleSets
	}
...
func TestSetAllPlatformFaultDomainCountNoMasters(t *testing.T) {
	// check that the default value is nil
	cs := CreateMockContainerService("testcluster", defaultTestClusterVer, 1, 3, false)
...
func TestSetVMASPlatformFaultDomainCountSetsOnlyVMASAgentPools(t *testing.T) {
	// check that the default value is nil
	cs := CreateMockContainerService("testcluster", defaultTestClusterVer, 1, 3, false)
	cs.Properties.MasterProfile.AvailabilityProfile = AvailabilitySet
	for _, pool := range cs.Properties.AgentPoolProfiles {
	...
	// check that pfdc can be set to legal values
	for i := 1; i <= 3; i++ {
		cs.SetVMASPlatformFaultDomainCount(i)
		if *cs.Properties.MasterProfile.PlatformFaultDomainCount != i {
			t.Errorf("expected master platformFaultDomainCount to be %d, not %v", i, cs.Properties.MasterProfile.PlatformFaultDomainCount)
		}
		for _, pool := range cs.Properties.AgentPoolProfiles {
...
func TestSetVMASPlatformFaultDomainCountDontSetVMSSMasters(t *testing.T) {
	// check that the default value is nil
	cs := CreateMockContainerService("testcluster", defaultTestClusterVer, 1, 3, false)
	...
	for _, pool := range cs.Properties.AgentPoolProfiles {
		...
		pool.AvailabilityProfile = AvailabilitySet
	}
