...
func TestLoadContainerServiceForAgentPoolOnlyClusterWithRawJSON(t *testing.T) {
	...
	cs, _, err := apiloader.LoadContainerServiceForAgentPoolOnlyCluster(rawJSON, v20170831.APIVersion, true, false, "1.13.12", nil)
	...
	cs, _, err = apiloader.LoadContainerServiceForAgentPoolOnlyCluster(rawJSON20180331, v20180331.APIVersion, true, false, "1.13.12", nil)
