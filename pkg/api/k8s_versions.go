...
var k8sComponentVersions = map[string]map[string]string{
	"1.17": {
		"dockerEngine":                     "1.13.*",
		"dashboard":                        "oss/kubernetes/kubernetes-dashboard:v1.10.1",
		"exechealthz":                      "oss/kubernetes/exechealthz:1.2",
		"addon-resizer":                    "oss/kubernetes/autoscaler/addon-resizer:1.8.5",
		"heapster":                         "oss/kubernetes/heapster:v1.5.4",
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.3.5",
		"coredns":                          "oss/kubernetes/coredns:1.6.2",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.15.4",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v9.0.2",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.15.4",
		"pause":                            "pause:1.2.0",
		"tiller":                           "oss/kubernetes/tiller:v2.13.1",
		"rescheduler":                      "oss/kubernetes/rescheduler:v0.4.0",
		...
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.16.2",
		NVIDIADevicePluginAddonName:        "oss/nvidia/k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.10",
	...
	"1.16": {
		...
		"addon-resizer":                    "oss/kubernetes/autoscaler/addon-resizer:1.8.5",
		"heapster":                         "oss/kubernetes/heapster:v1.5.4",
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.3.4",
		"coredns":                          "oss/kubernetes/coredns:1.6.2",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.15.4",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v9.0.2",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.15.4",
	...
	"1.15": {
		...
		"addon-resizer":                    "oss/kubernetes/autoscaler/addon-resizer:1.8.5",
		"heapster":                         "oss/kubernetes/heapster:v1.5.4",
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.2.1",
		"coredns":                          "oss/kubernetes/coredns:1.6.2",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.15.4",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v9.0.2",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.15.4",
		...
		ContainerMonitoringAddonName:       "oms:ciprod10182019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.15.3",
		NVIDIADevicePluginAddonName:        "oss/nvidia/k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
	...
	"1.14": {
		...
		"dashboard":                        "oss/kubernetes/kubernetes-dashboard:v1.10.1",
		"exechealthz":                      "oss/kubernetes/exechealthz:1.2",
		"addon-resizer":                    "oss/kubernetes/autoscaler/addon-resizer:1.8.4",
		"heapster":                         "oss/kubernetes/heapster:v1.5.4",
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.2.1",
		"coredns":                          "oss/kubernetes/coredns:1.6.2",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.15.4",
		...
		ContainerMonitoringAddonName:       "oms:ciprod10182019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.14.6",
		NVIDIADevicePluginAddonName:        "oss/nvidia/k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
	...
	"1.13": {
		...
		"coredns":                          "oss/kubernetes/coredns:1.6.2",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.15.4",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v8.9.1",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.15.4",
		"pause":                            "pause:1.2.0",
		"tiller":                           "oss/kubernetes/tiller:v2.13.1",
		"rescheduler":                      "oss/kubernetes/rescheduler:v0.4.0",
		...
		ContainerMonitoringAddonName:       "oms:ciprod10182019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.13.7",
		NVIDIADevicePluginAddonName:        "oss/nvidia/k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
	...
	"1.12": {
		...
		ContainerMonitoringAddonName:       "oms:ciprod10182019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.12.8",
		NVIDIADevicePluginAddonName:        "oss/nvidia/k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
	...
	"1.11": {
		...
		ContainerMonitoringAddonName:       "oms:ciprod10182019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.3.9",
		NVIDIADevicePluginAddonName:        "oss/nvidia/k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
	...
	"1.10": {
		...
		"pause":                            "pause:1.2.0",
		"tiller":                           "oss/kubernetes/tiller:v2.13.1",
		"rescheduler":                      "oss/kubernetes/rescheduler:v0.3.1",
		"aci-connector":                    "virtual-kubelet:latest",
		ContainerMonitoringAddonName:       "oms:ciprod10182019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.2.5",
		NVIDIADevicePluginAddonName:        "oss/nvidia/k8s-device-plugin:1.10",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.8",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
		"podeviction":                      DefaultKubernetesCtrlMgrPodEvictionTimeout,
		"routeperiod":                      DefaultKubernetesCtrlMgrRouteReconciliationPeriod,
	...
	"1.9": {
		...
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.2.1",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.15.4",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v8.6",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.15.4",
		"pause":                            "pause:1.2.0",
		"tiller":                           "oss/kubernetes/tiller:v2.13.1",
		"rescheduler":                      "oss/kubernetes/rescheduler:v0.3.1",
		...
		ContainerMonitoringAddonName:       "oms:ciprod10182019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "oss/kubernetes/autoscaler/cluster-autoscaler:v1.1.2",
		"k8s-dns-sidecar":                  "oss/kubernetes/k8s-dns-sidecar:1.14.7",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
		"podeviction":                      DefaultKubernetesCtrlMgrPodEvictionTimeout,
		"routeperiod":                      DefaultKubernetesCtrlMgrRouteReconciliationPeriod,
	...
	"1.8": {
		...
		"dashboard":                        "oss/kubernetes/kubernetes-dashboard:v1.10.1",
		"exechealthz":                      "oss/kubernetes/exechealthz:1.2",
		"addon-resizer":                    "oss/kubernetes/autoscaler/addon-resizer:1.7",
		"heapster":                         "oss/kubernetes/heapster:v1.5.1",
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.2.1",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.14.13",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v8.6",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.14.8",
		"pause":                            "pause:1.2.0",
		"tiller":                           "oss/kubernetes/tiller:v2.13.1",
		"rescheduler":                      "oss/kubernetes/rescheduler:v0.3.1",
		"aci-connector":                    "virtual-kubelet:latest",
	...
	"1.7": {
		...
		"heapster":                         "oss/kubernetes/heapster:v1.5.1",
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.2.1",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.14.5",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v8.6",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.14.5",
		"pause":                            "pause:1.2.0",
		"tiller":                           "oss/kubernetes/tiller:v2.13.1",
		"rescheduler":                      "oss/kubernetes/rescheduler:v0.3.1",
		"aci-connector":                    "virtual-kubelet:latest",
	...
	"1.6": {
		...
		"exechealthz":                      "oss/kubernetes/exechealthz:1.2",
		"addon-resizer":                    "oss/kubernetes/autoscaler/addon-resizer:1.7",
		"heapster":                         "oss/kubernetes/heapster:v1.3.0",
		"metrics-server":                   "oss/kubernetes/metrics-server:v0.2.1",
		"kube-dns":                         "oss/kubernetes/k8s-dns-kube-dns:1.14.5",
		"addon-manager":                    "oss/kubernetes/kube-addon-manager:v6.5",
		"dnsmasq":                          "oss/kubernetes/k8s-dns-dnsmasq-nanny:1.14.5",
		"pause":                            "pause:1.2.0",
		"tiller":                           "oss/kubernetes/tiller:v2.13.1",
		"rescheduler":                      "oss/kubernetes/rescheduler:v0.3.1",
...
func getVersionOverrides(v string) map[string]string {
	switch v {
	case "1.8.11":
		return map[string]string{"kube-dns": "oss/kubernetes/k8s-dns-kube-dns:1.14.9"}
	case "1.8.9":
...
func getK8sVersionComponents(version string, overrides map[string]string) map[string]string {
	...
	case "1.17":
		ret = map[string]string{
			"hyperkube":                        "oss/kubernetes/hyperkube:v" + version,
			"ccm":                              "oss/kubernetes/cloud-controller-manager-amd64:v" + version,
