...
func getK8sVersionComponents(version, kubernetesImageBaseType string, overrides map[string]string) map[string]string {
	...
	case "1.24":
		ret = map[string]string{
			...
			common.CloudControllerManagerComponentName:        "oss/kubernetes/azure-cloud-controller-manager:v1.24.19",
			common.CloudNodeManagerAddonName:                  "oss/kubernetes/azure-cloud-node-manager:v1.24.19",
