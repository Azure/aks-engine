...
var k8sComponentVersions = map[string]map[string]string{
	"1.16": {
		...
		"cluster-autoscaler":               "cluster-autoscaler:v1.15.1",
	...
	"1.14": {
		...
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "cluster-autoscaler:v1.14.4",
		NVIDIADevicePluginAddonName:        "k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "k8s-dns-sidecar-amd64:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
	...
	"1.13": {
		...
		ContainerMonitoringAddonName:       "oms:ciprod04232019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "cluster-autoscaler:v1.13.6",
		NVIDIADevicePluginAddonName:        "k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "k8s-dns-sidecar-amd64:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
	...
	"1.12": {
		...
		ContainerMonitoringAddonName:       "oms:ciprod04232019",
		AzureCNINetworkMonitoringAddonName: "networkmonitor:v0.0.6",
		"cluster-autoscaler":               "cluster-autoscaler:v1.12.7",
		NVIDIADevicePluginAddonName:        "k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "k8s-dns-sidecar-amd64:1.14.10",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
...
func getK8sVersionComponents(version string, overrides map[string]string) map[string]string {
	...
	case "1.16":
		ret = map[string]string{
			...
			DashboardAddonName:                 k8sComponentVersions["1.16"]["dashboard"],
			"exechealthz":                      k8sComponentVersions["1.16"]["exechealthz"],
			"addonresizer":                     k8sComponentVersions["1.16"]["addon-resizer"],
			"heapster":                         k8sComponentVersions["1.16"]["heapster"],
			MetricsServerAddonName:             k8sComponentVersions["1.16"]["metrics-server"],
			"coredns":                          k8sComponentVersions["1.16"]["coredns"],
			"kube-dns":                         k8sComponentVersions["1.16"]["kube-dns"],
			"addonmanager":                     k8sComponentVersions["1.16"]["addon-manager"],
			"dnsmasq":                          k8sComponentVersions["1.16"]["dnsmasq"],
			"pause":                            k8sComponentVersions["1.16"]["pause"],
			TillerAddonName:                    k8sComponentVersions["1.16"]["tiller"],
			ReschedulerAddonName:               k8sComponentVersions["1.16"]["rescheduler"],
			ACIConnectorAddonName:              k8sComponentVersions["1.16"]["aci-connector"],
			ContainerMonitoringAddonName:       k8sComponentVersions["1.16"][ContainerMonitoringAddonName],
			AzureCNINetworkMonitoringAddonName: k8sComponentVersions["1.16"][AzureCNINetworkMonitoringAddonName],
			ClusterAutoscalerAddonName:         k8sComponentVersions["1.16"]["cluster-autoscaler"],
			"k8s-dns-sidecar":                  k8sComponentVersions["1.16"]["k8s-dns-sidecar"],
			"nodestatusfreq":                   k8sComponentVersions["1.16"]["nodestatusfreq"],
			"nodegraceperiod":                  k8sComponentVersions["1.16"]["nodegraceperiod"],
			"podeviction":                      k8sComponentVersions["1.16"]["podeviction"],
			"routeperiod":                      k8sComponentVersions["1.16"]["routeperiod"],
			"backoffretries":                   k8sComponentVersions["1.16"]["backoffretries"],
			"backoffjitter":                    k8sComponentVersions["1.16"]["backoffjitter"],
			"backoffduration":                  k8sComponentVersions["1.16"]["backoffduration"],
			"backoffexponent":                  k8sComponentVersions["1.16"]["backoffexponent"],
			"ratelimitqps":                     k8sComponentVersions["1.16"]["ratelimitqps"],
			"ratelimitbucket":                  k8sComponentVersions["1.16"]["ratelimitbucket"],
			"gchighthreshold":                  k8sComponentVersions["1.16"]["gchighthreshold"],
			"gclowthreshold":                   k8sComponentVersions["1.16"]["gclowthreshold"],
			NVIDIADevicePluginAddonName:        k8sComponentVersions["1.16"][NVIDIADevicePluginAddonName],
		}
	case "1.15":
		ret = map[string]string{
			"hyperkube":                        "hyperkube-amd64:v" + version,
	...
	case "1.6":
		ret = map[string]string{
			"hyperkube":                        "hyperkube-amd64:v" + version,
			DashboardAddonName:                 k8sComponentVersions["1.6"]["dashboard"],
			...
			MetricsServerAddonName:             k8sComponentVersions["1.6"]["metrics-server"],
			...
			TillerAddonName:                    k8sComponentVersions["1.6"]["tiller"],
			ReschedulerAddonName:               k8sComponentVersions["1.6"]["rescheduler"],
			ACIConnectorAddonName:              k8sComponentVersions["1.6"]["aci-connector"],
