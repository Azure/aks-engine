...
const (
	...
	csiLivenessProbeImageReference                    string = "oss/kubernetes-csi/livenessprobe:v2.1.0"
	csiLivenessProbeWindowsImageReference             string = "oss/kubernetes-csi/livenessprobe:v2.1.0"
	csiNodeDriverRegistrarImageReference              string = "oss/kubernetes-csi/csi-node-driver-registrar:v2.0.1"
	csiNodeDriverRegistrarWindowsImageReference       string = "oss/kubernetes-csi/csi-node-driver-registrar:v2.0.1"
	...
	csiSecretsStoreProviderAzureImageReference        string = "oss/azure/secrets-store/provider-azure:0.0.10"
	csiSecretsStoreDriverImageReference               string = "oss/kubernetes-csi/secrets-store/driver:v0.0.17"
