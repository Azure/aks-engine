...
const (
	// DefaultExternalContainerImageRegistry is our external container registry dependency
	DefaultExternalContainerImageRegistry = "k8s.gcr.io/"
	// DefaultExternalContainerImageRegistryChinaCloud is our external container registry dependency for China cloud context
	DefaultExternalContainerImageRegistryChinaCloud = "gcr.azk8s.cn/google_containers/"
)
