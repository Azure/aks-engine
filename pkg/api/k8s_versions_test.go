...
func TestGetK8sVersionComponents(t *testing.T) {
	...
	expected := map[string]string{
		...
		common.WindowsArtifactAzsComponentName:            "v1.18.0-azs/windowszip/v1.18.0-azs-1int.zip",
	...
	expected = map[string]string{
		...
		common.WindowsArtifactAzsComponentName:            "v1.17.0-azs/windowszip/v1.17.0-azs-1int.zip",
		common.DashboardAddonName:                         dashboardImageReference,
		common.DashboardMetricsScraperContainerName:       dashboardMetricsScraperImageReference,
		common.ExecHealthZComponentName:                   getDefaultImage(common.ExecHealthZComponentName, kubernetesImageBaseType),
		common.AddonResizerComponentName:                  k8sComponent[common.AddonResizerComponentName],
	...
	expected = map[string]string{
		...
		common.WindowsArtifactAzsComponentName:            "v1.16.0-azs/windowszip/v1.16.0-azs-1int.zip",
		common.DashboardAddonName:                         dashboardImageReference,
		common.DashboardMetricsScraperContainerName:       dashboardMetricsScraperImageReference,
		common.ExecHealthZComponentName:                   getDefaultImage(common.ExecHealthZComponentName, kubernetesImageBaseType),
		common.AddonResizerComponentName:                  k8sComponent[common.AddonResizerComponentName],
	...
	expected = map[string]string{
		...
		common.WindowsArtifactAzsComponentName:            "v1.15.0-azs/windowszip/v1.15.0-azs-1int.zip",
		common.DashboardAddonName:                         dashboardImageReference,
		common.DashboardMetricsScraperContainerName:       dashboardMetricsScraperImageReference,
		common.ExecHealthZComponentName:                   getDefaultImage(common.ExecHealthZComponentName, kubernetesImageBaseType),
		common.AddonResizerComponentName:                  k8sComponent[common.AddonResizerComponentName],
	...
	expected = map[string]string{
		...
		common.WindowsArtifactAzsComponentName:            "v1.14.0-azs/windowszip/v1.14.0-azs-1int.zip",
		common.DashboardAddonName:                         dashboardImageReference,
		common.DashboardMetricsScraperContainerName:       dashboardMetricsScraperImageReference,
		common.ExecHealthZComponentName:                   getDefaultImage(common.ExecHealthZComponentName, kubernetesImageBaseType),
		common.AddonResizerComponentName:                  k8sComponent[common.AddonResizerComponentName],
	...
	expected = map[string]string{
		...
		common.WindowsArtifactAzsComponentName:            "v1.13.0-azs/windowszip/v1.13.0-azs-1int.zip",
		common.DashboardAddonName:                         dashboardImageReference,
		common.ExecHealthZComponentName:                   getDefaultImage(common.ExecHealthZComponentName, kubernetesImageBaseType),
		common.AddonResizerComponentName:                  k8sComponent[common.AddonResizerComponentName],
		common.HeapsterAddonName:                          getDefaultImage(common.HeapsterAddonName, kubernetesImageBaseType),
