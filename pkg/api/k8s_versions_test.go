...
func TestGetK8sVersionComponents(t *testing.T) {
	...
	expected := map[string]string{
		...
		common.KeyVaultFlexVolumeAddonName:     k8sComponent[common.KeyVaultFlexVolumeAddonName],
		common.IPMASQAgentAddonName:            k8sComponent[common.IPMASQAgentAddonName],
