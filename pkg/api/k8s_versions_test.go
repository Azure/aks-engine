...
func TestGetK8sVersionComponents(t *testing.T) {
	...
	expected := map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.15"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.15"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.15"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.15"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.15"]["aci-connector"],
		...
		ClusterAutoscalerAddonName:         k8sComponentVersions["1.15"]["cluster-autoscaler"],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.14"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.14"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.14"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.14"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.14"]["aci-connector"],
		...
		ClusterAutoscalerAddonName:         k8sComponentVersions["1.14"]["cluster-autoscaler"],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.13"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.13"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.13"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.13"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.13"]["aci-connector"],
		...
		ClusterAutoscalerAddonName:         k8sComponentVersions["1.13"]["cluster-autoscaler"],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.12"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.12"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.12"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.12"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.12"]["aci-connector"],
		...
		ClusterAutoscalerAddonName:         k8sComponentVersions["1.12"]["cluster-autoscaler"],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.11"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.11"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.11"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.11"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.11"]["aci-connector"],
		...
		ClusterAutoscalerAddonName:         k8sComponentVersions["1.11"]["cluster-autoscaler"],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.10"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.10"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.10"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.10"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.10"]["aci-connector"],
		...
		ClusterAutoscalerAddonName:         k8sComponentVersions["1.10"]["cluster-autoscaler"],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.9"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.9"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.9"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.9"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.9"]["aci-connector"],
		...
		ClusterAutoscalerAddonName:         k8sComponentVersions["1.9"]["cluster-autoscaler"],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.8"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.8"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.8"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.8"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.8"]["aci-connector"],
		ContainerMonitoringAddonName:       k8sComponentVersions["1.11"][ContainerMonitoringAddonName],
	...
	expected = map[string]string{
		...
		DashboardAddonName:                 k8sComponentVersions["1.7"]["dashboard"],
		...
		MetricsServerAddonName:             k8sComponentVersions["1.7"]["metrics-server"],
		...
		TillerAddonName:                    k8sComponentVersions["1.7"]["tiller"],
		ReschedulerAddonName:               k8sComponentVersions["1.7"]["rescheduler"],
		ACIConnectorAddonName:              k8sComponentVersions["1.7"]["aci-connector"],
		ContainerMonitoringAddonName:       k8sComponentVersions["1.11"][ContainerMonitoringAddonName],
