...
func TestAssignDefaultAddonImages(t *testing.T) {
	...
	defaultAddonImages := map[string]string{
		TillerAddonName:                    "mcr.microsoft.com/oss/kubernetes/tiller:v2.13.1",
		ACIConnectorAddonName:              "microsoft/virtual-kubelet:latest",
		ClusterAutoscalerAddonName:         "mcr.microsoft.com/oss/kubernetes/autoscaler/cluster-autoscaler:v1.3.9",
		...
		DashboardAddonName:                 "mcr.microsoft.com/oss/kubernetes/kubernetes-dashboard:v1.10.1",
		ReschedulerAddonName:               "mcr.microsoft.com/oss/kubernetes/rescheduler:v0.4.0",
		MetricsServerAddonName:             "mcr.microsoft.com/oss/kubernetes/metrics-server:v0.2.1",
		NVIDIADevicePluginAddonName:        "mcr.microsoft.com/oss/nvidia/k8s-device-plugin:1.11",
		ContainerMonitoringAddonName:       "mcr.microsoft.com/azuremonitor/containerinsights/ciprod:ciprod10182019",
		IPMASQAgentAddonName:               "mcr.microsoft.com/ip-masq-agent-amd64:v2.5.0",
		AzureCNINetworkMonitoringAddonName: "mcr.microsoft.com/containernetworking/networkmonitor:v0.0.6",
		DNSAutoscalerAddonName:             "mcr.microsoft.com/cluster-proportional-autoscaler-amd64:1.1.1",
		HeapsterAddonName:                  "mcr.microsoft.com/oss/kubernetes/heapster:v1.5.4",
