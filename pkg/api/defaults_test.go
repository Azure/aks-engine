...
func TestSetCustomCloudProfileDefaults(t *testing.T) {
	...
	if mockCSAuth.Properties.CustomCloudProfile.AuthenticationMethod != ClientSecret {
	...
	if mockCSAuth.Properties.CustomCloudProfile.IdentitySystem != AzureAD {
	...
	if mockCSI.Properties.CustomCloudProfile.AuthenticationMethod != ClientCertificate {
	...
	if mockCSI.Properties.CustomCloudProfile.IdentitySystem != ADFS {
