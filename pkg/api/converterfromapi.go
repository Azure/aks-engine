...
func convertMasterProfileToVLabs(api *MasterProfile, vlabsProfile *vlabs.MasterProfile) {
	...
	if api.ImageRef != nil {
		...
		vlabsProfile.ImageRef.Image = api.ImageRef.Image
		vlabsProfile.ImageRef.ImageVersion = api.ImageRef.ImageVersion
	}
...
func convertAgentPoolProfileToVLabs(api *AgentPoolProfile, p *vlabs.AgentPoolProfile) {
	...
	if api.ImageRef != nil {
		...
		p.ImageRef.Image = api.ImageRef.Image
		p.ImageRef.ImageVersion = api.ImageRef.ImageVersion
	}
