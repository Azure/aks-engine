...
func TestConvertVLabsKubernetesImagesConfig(t *testing.T) {
	const (
		...
		Properties: &vlabs.Properties{
			OrchestratorProfile: &vlabs.OrchestratorProfile{
				...
				KubernetesConfig: &vlabs.KubernetesConfig{
					KubernetesImagesConfig: &vlabs.KubernetesImagesConfig{
						ImageBaseConfig: &vlabs.ImageBaseConfig{
							...
							HeapsterImageBase:                      heapsterImageBase,
							AddonResizerImageBase:                  addonResizerImageBase,
							ClusterAutoscalerImageBase:             clusterAutoscalerImageBase,
							DashboardImageBase:                     dashboardImageBase,
							ReschedulerImageBase:                   reschedulerImageBase,
							MetricsServerImageBase:                 metricsServerImageBase,
							IPMasqAgentImageBase:                   ipMasqAgentImageBase,
							ClusterProportionalAutoscalerImageBase: clusterProportionalAutoscalerImageBase,
							TillerImageBase:                        tillerImageBase,
							ACIConnectorImageBase:                  aciConnectorImageBase,
							NVIDIAImageBase:                        nvidiaImageBase,
							AzureCNIImageBase:                      azureCNIImageBase,
	...
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.KubernetesImageBase != kubernetesImageBase {
		t.Errorf("incorrect ImageBaseConfig.KubernetesImageBase, expect: '%s', actual: '%s'", kubernetesImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.KubernetesImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.HyperkubeImageBase != hyperkubeImageBase {
		t.Errorf("incorrect ImageBaseConfig.HyperkubeImageBase, expect: '%s', actual: '%s'", hyperkubeImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.HyperkubeImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.PauseImageBase != pauseImageBase {
		t.Errorf("incorrect ImageBaseConfig.PauseImageBase, expect: '%s', actual: '%s'", pauseImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.PauseImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.AddonManagerImageBase != addonManagerImageBase {
		t.Errorf("incorrect ImageBaseConfig.AddonManagerImageBase, expect: '%s', actual: '%s'", addonManagerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.AddonManagerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.CloudControllerManagerImageBase != cloudControllerManagerImageBase {
		t.Errorf("incorrect ImageBaseConfig.CloudControllerManagerImageBase, expect: '%s', actual: '%s'", cloudControllerManagerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.CloudControllerManagerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.K8sDNSSidecarImageBase != k8sDNSSidecarImageBase {
		t.Errorf("incorrect ImageBaseConfig.K8sDNSSidecarImageBase, expect: '%s', actual: '%s'", k8sDNSSidecarImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.K8sDNSSidecarImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.CoreDNSImageBase != coreDNSImageBase {
		t.Errorf("incorrect ImageBaseConfig.CoreDNSImageBase, expect: '%s', actual: '%s'", coreDNSImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.CoreDNSImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.KubeDNSImageBase != kubeDNSImageBase {
		t.Errorf("incorrect ImageBaseConfig.KubeDNSImageBase, expect: '%s', actual: '%s'", kubeDNSImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.KubeDNSImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.DNSMasqImageBase != dnsMasqImageBase {
		t.Errorf("incorrect ImageBaseConfig.DNSMasqImageBase, expect: '%s', actual: '%s'", dnsMasqImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.DNSMasqImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.HeapsterImageBase != heapsterImageBase {
		t.Errorf("incorrect ImageBaseConfig.HeapsterImageBase, expect: '%s', actual: '%s'", heapsterImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.HeapsterImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.AddonResizerImageBase != addonResizerImageBase {
		t.Errorf("incorrect ImageBaseConfig.AddonResizerImageBase, expect: '%s', actual: '%s'", addonResizerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.AddonResizerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ClusterAutoscalerImageBase != clusterAutoscalerImageBase {
		t.Errorf("incorrect ImageBaseConfig.ClusterAutoscalerImageBase, expect: '%s', actual: '%s'", clusterAutoscalerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ClusterAutoscalerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.DashboardImageBase != dashboardImageBase {
		t.Errorf("incorrect ImageBaseConfig.DashboardImageBase, expect: '%s', actual: '%s'", dashboardImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.DashboardImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ReschedulerImageBase != reschedulerImageBase {
		t.Errorf("incorrect ImageBaseConfig.ReschedulerImageBase, expect: '%s', actual: '%s'", reschedulerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ReschedulerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.MetricsServerImageBase != metricsServerImageBase {
		t.Errorf("incorrect ImageBaseConfig.MetricsServerImageBase, expect: '%s', actual: '%s'", metricsServerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.MetricsServerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.IPMasqAgentImageBase != ipMasqAgentImageBase {
		t.Errorf("incorrect ImageBaseConfig.IPMasqAgentImageBase, expect: '%s', actual: '%s'", ipMasqAgentImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.IPMasqAgentImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ClusterProportionalAutoscalerImageBase != clusterProportionalAutoscalerImageBase {
		t.Errorf("incorrect ImageBaseConfig.ClusterProportionalAutoscalerImageBase, expect: '%s', actual: '%s'", clusterProportionalAutoscalerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ClusterProportionalAutoscalerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.TillerImageBase != tillerImageBase {
		t.Errorf("incorrect ImageBaseConfig.TillerImageBase, expect: '%s', actual: '%s'", tillerImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.TillerImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ACIConnectorImageBase != aciConnectorImageBase {
		t.Errorf("incorrect ImageBaseConfig.ACIConnectorImageBase, expect: '%s', actual: '%s'", aciConnectorImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.ACIConnectorImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.NVIDIAImageBase != nvidiaImageBase {
		t.Errorf("incorrect ImageBaseConfig.NVIDIAImageBase, expect: '%s', actual: '%s'", nvidiaImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.NVIDIAImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.AzureCNIImageBase != azureCNIImageBase {
		t.Errorf("incorrect ImageBaseConfig.AzureCNIImageBase, expect: '%s', actual: '%s'", azureCNIImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.AzureCNIImageBase)
	}
	if cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.CalicoImageBase != calicoImageBase {
		t.Errorf("incorrect ImageBaseConfig.CalicoImageBase, expect: '%s', actual: '%s'", calicoImageBase, cs.Properties.OrchestratorProfile.KubernetesConfig.KubernetesImagesConfig.ImageBaseConfig.CalicoImageBase)
	}
}
