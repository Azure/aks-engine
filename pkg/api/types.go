...
// ImageRepoOverride enables granular, per-image overrides for the registry
// location and repo.
// Additionally it allows mapping a common version tag
// (e.g. "v1.13.1", to an alternate tag name... e.g. "v1.13.1-foo"). The mapped
// tag name is the tag used to fetch the image.
type ImageRepoOverride struct {
	Registry string            `json:"registry,omitempty"`
	Repo     string            `json:"repo,omitemtpy"`
