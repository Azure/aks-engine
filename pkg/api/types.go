...
type WindowsProfile struct {
	...
	LicenseType               *WindowsLicenseType `json:"licenseType,omitempty"`
}
...
// HasLicenseType returns true if LicenseType is set
func (w *WindowsProfile) HasLicenseType() bool {
	return w.LicenseType != nil
}

// IsValidLicenseType returns true if LicenseType is valid
func (w *WindowsProfile) IsValidLicenseType() bool {
	return w.HasLicenseType() && (*w.LicenseType == WindowsLicenseTypeServer || *w.LicenseType == WindowsLicenseTypeClient)
}
