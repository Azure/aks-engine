...
var (
	...
	DefaultKubernetesSpecConfig = KubernetesSpecConfig{
		...
		CNIPluginsDownloadURL:            "https://kubernetesartifacts.azureedge.net/cni-plugins/" + CNIPluginVer + "/binaries/cni-plugins-amd64-linux" + CNIPluginVer + ".tgz",
	...
	AzureChinaCloudSpec = AzureEnvironmentSpecConfig{
		...
		KubernetesSpecConfig: KubernetesSpecConfig{
			...
			CNIPluginsDownloadURL:            "https://mirror.azk8s.cn/kubernetes/containernetworking-plugins/cni-plugins-amd64-linux" + CNIPluginVer + ".tgz",
