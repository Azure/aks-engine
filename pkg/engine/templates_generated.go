  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        - --azure.client-id={{ContainerConfig "clientID"}}
        - --azure.tenant-id={{ContainerConfig "tenantID"}}
        - --azure.auth-mode=obo
        ...
        - --azure.resource-id=/subscriptions/{{ContainerConfig "subscriptionID"}}/resourceGroups/{{ContainerConfig "resourceGroup"}}/providers/Microsoft.Kubernetes/connectedClusters/{{ContainerConfig "clusterName"}}
