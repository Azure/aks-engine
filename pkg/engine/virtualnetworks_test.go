...
func TestCreateVirtualNetwork(t *testing.T) {
	...
	// Test master vnet with azure cni ipv6 dual stack feature enabled
	cs = &api.ContainerService{
		Properties: &api.Properties{
			OrchestratorProfile: &api.OrchestratorProfile{
				OrchestratorType: "Kubernetes",
...
func TestCreateVirtualNetworkVMSS(t *testing.T) {
	...
	// Test with azure cni ipv6 dual stack feature enabled
	cs = &api.ContainerService{
		Properties: &api.Properties{
			OrchestratorProfile: &api.OrchestratorProfile{
				OrchestratorType: "Kubernetes",
...
func TestCreateHostedMasterVirtualNetwork(t *testing.T) {
	...
	// test with azurecni ipv6 dual stack feature enabled
	cs = &api.ContainerService{
		Properties: &api.Properties{
			OrchestratorProfile: &api.OrchestratorProfile{
				OrchestratorType: "Kubernetes",
