...
func TestK8sVars(t *testing.T) {
	...
	expectedMap := map[string]interface{}{
		...
		"cloudInitFiles": map[string]interface{}{
			...
			"cisUFWConf":                       getBase64EncodedGzippedCustomScript(cisUFWConf),
			"cisUFWUserRules":                  getBase64EncodedGzippedCustomScript(cisUFWUserRules),
			"cisUFWBeforeRules":                getBase64EncodedGzippedCustomScript(cisUFWBeforeRules),
			"cisUFWSysctlConf":                 getBase64EncodedGzippedCustomScript(cisUFWSysctlConf),
		},
