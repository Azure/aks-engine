...
func (m *MockClient) ListPodsByOptions(namespace string, opts v11.ListOptions) (*v10.PodList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPodsByOptions", namespace, opts)
...
func (mr *MockClientMockRecorder) ListPodsByOptions(namespace, opts interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPodsByOptions", reflect.TypeOf((*MockClient)(nil).ListPodsByOptions), namespace, opts)
}
...
func (m *MockClient) ListServiceAccountsByOptions(namespace string, opts v11.ListOptions) (*v10.ServiceAccountList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListServiceAccountsByOptions", namespace, opts)
...
func (mr *MockClientMockRecorder) ListServiceAccountsByOptions(namespace, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListServiceAccountsByOptions", reflect.TypeOf((*MockClient)(nil).ListServiceAccountsByOptions), namespace, opts)
}
