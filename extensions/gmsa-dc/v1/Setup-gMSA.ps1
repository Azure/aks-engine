...
if (Get-AdGroupMember -Identity "Enterprise Admins" | Select-String -Pattern "gmsa-admin" -Quiet) {
    ...
    Invoke-WebRequest -UseBasicParsing https://raw.githubusercontent.com/JeremyWx/gmsa-dc/master/extensions/gmsa-dc/v1/GenerateCredentialSpecResource.ps1 -OutFile GenerateCredentialSpecResource.ps1
